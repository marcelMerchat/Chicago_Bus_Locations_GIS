...
#   Example-086 for Minneapolis, MN. The code for the shiny example is at
#   https://github.com/rstudio/shiny-examplesMy contribution is to adapt it for
#   the API for the Chicago Transit Authority
